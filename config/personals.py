...
# Your legal name
first_name = "Kishor"              # Your first name in quotes Eg: "First", "Sai"
middle_name = "Suryakant"                   # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Madane"               # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "7447765404"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Vasai, Maharashtra, India"                  # Los Angeles, San Francisco, etc.
'''
...
street = "Vidyavardhini’s College of Engineering and Technology, Vasai"
state = "Maharashtra"
zipcode = "401208"
country = "India"
